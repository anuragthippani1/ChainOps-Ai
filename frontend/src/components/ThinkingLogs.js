...
const ThinkingLogs = () => {
  ...
  const hasLogs = chatMessages.length > 0;
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {!hasLogs ? (
        <div className="max-w-xl rounded-lg border border-gray-200 bg-white p-6 text-sm text-gray-600">
          <div className="flex items-center">
            <Brain className="h-5 w-5 mr-2 text-gray-400" />
            <span className="font-medium text-gray-800">No logs captured yet</span>
          </div>
          <p className="mt-2">
            Thinking logs are available for debugging and demos. Start a conversation in the assistant to
            populate this view.
          </p>
        </div>
      ) : (
